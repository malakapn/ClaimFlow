        ...
        <div style={{ maxWidth: 620, margin: "48px auto", padding: "0 24px" }}>
          ...
          <div style={{ background: "#fff", borderRadius: 14, padding: "40px 36px", boxShadow: "0 2px 20px rgba(0,0,0,0.08)" }}>
            ...
            {step === 1 && <>
              ...
              <input className="cf-input" style={inp} value={data.defName} onChange={e => set("defName", e.target.value)} placeholder="e.g. John Smith or ABC Contractors LLC" />
              ...
              <input className="cf-input" style={inp} value={data.defAddress} onChange={e => set("defAddress", e.target.value)} placeholder="123 Main St" />
              <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: 12 }}>
                <div><label style={lbl}>City</label><input className="cf-input" style={inp} value={data.defCity} onChange={e => set("defCity", e.target.value)} placeholder="City" /></div>
                <div><label style={lbl}>State</label><input className="cf-input" style={inp} value={data.defState} onChange={e => set("defState", e.target.value)} placeholder="CA" /></div>
                <div><label style={lbl}>ZIP</label><input className="cf-input" style={inp} value={data.defZip} onChange={e => set("defZip", e.target.value)} placeholder="90210" /></div>
              </div>
            </>}
            ...
            {step === 3 && <>
              ...
              <input className="cf-input" style={inp} type="date" value={data.incidentDate} onChange={e => set("incidentDate", e.target.value)} />
              <label style={lbl}>Describe What Happened *</label>
              <textarea className="cf-input" style={{ ...inp, height: 120, resize: "vertical" }} value={data.incidentDesc} onChange={e => set("incidentDesc", e.target.value)} placeholder="Explain the situation clearly — what happened, when, where, and what was agreed upon..." />
              <label style={lbl}>Evidence You Have</label>
              <textarea className="cf-input" style={{ ...inp, height: 90, resize: "vertical" }} value={data.evidence} onChange={e => set("evidence", e.target.value)} placeholder="e.g. Text messages, receipts, contract, photos of damage, emails..." />
            </>}
            ...
            {step === 4 && <>
              ...
              <input className="cf-input" style={inp} type="number" value={data.amountTotal} onChange={e => set("amountTotal", e.target.value)} placeholder="e.g. 2500" />
              <label style={lbl}>Amount Breakdown (optional)</label>
              <textarea className="cf-input" style={{ ...inp, height: 100, resize: "vertical" }} value={data.amountBreakdown} onChange={e => set("amountBreakdown", e.target.value)} placeholder="e.g. $1,800 unpaid invoice + $400 late fees + $300 storage costs..." />
            ...
            {step === 5 && <>
              ...
              <input className="cf-input" style={inp} value={data.plName} onChange={e => set("plName", e.target.value)} placeholder="Your full name as it appears on ID" />
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                <div><label style={lbl}>Email</label><input className="cf-input" style={inp} type="email" value={data.plEmail} onChange={e => set("plEmail", e.target.value)} placeholder="you@email.com" /></div>
                <div><label style={lbl}>Phone</label><input className="cf-input" style={inp} type="tel" value={data.plPhone} onChange={e => set("plPhone", e.target.value)} placeholder="(555) 000-0000" /></div>
              </div>
              <label style={lbl}>Street Address</label>
              <input className="cf-input" style={inp} value={data.plAddress} onChange={e => set("plAddress", e.target.value)} placeholder="123 Your Street" />
              <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: 12 }}>
                <div><label style={lbl}>City</label><input className="cf-input" style={inp} value={data.plCity} onChange={e => set("plCity", e.target.value)} placeholder="City" /></div>
                <div><label style={lbl}>State</label><input className="cf-input" style={inp} value={data.plState} onChange={e => set("plState", e.target.value)} placeholder="CA" /></div>
                <div><label style={lbl}>ZIP</label><input className="cf-input" style={inp} value={data.plZip} onChange={e => set("plZip", e.target.value)} placeholder="90210" /></div>
              </div>
            </>}
...
// Belt-and-suspenders: mirror the four visibility properties inline so they
// cannot be lost even if .cf-input is stripped at build time. CSS class
// !important rules handle autofill; inline style handles everything else.
